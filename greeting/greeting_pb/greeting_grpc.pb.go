...
type GreetServiceClient interface {
	...
	//server streaming
	GreetManyTimes(ctx context.Context, in *GreetingManyTimesRequest, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error)
	//client streaming
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/greeting.GreetService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreetingManyTimesRequest, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greeting.GreetService/GreetManyTimes", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], "/greeting.GreetService/LongGreet", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceLongGreetClient) Send(m *LongGreetingRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceLongGreetClient) CloseAndRecv() (*LongGreetingResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveryoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greeting.GreetService/GreetEveryone", opts...)
	if err != nil {
		return nil, err
	}
...
type GreetService_GreetEveryoneClient interface {
	Send(*GreetingEveryoneRequest) error
	Recv() (*GreetingEveryoneResponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetEveryoneClient) Send(m *GreetingEveryoneRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneClient) Recv() (*GreetingEveryoneResponse, error) {
	m := new(GreetingEveryoneResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetServiceServer interface {
	...
	//server streaming
	GreetManyTimes(*GreetingManyTimesRequest, GreetService_GreetManyTimesServer) error
	//client streaming
...
func (UnimplementedGreetServiceServer) GreetManyTimes(*GreetingManyTimesRequest, GreetService_GreetManyTimesServer) error {
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greeting.GreetService/Greet",
	}
...
func _GreetService_GreetManyTimes_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GreetingManyTimesRequest)
...
func (x *greetServiceLongGreetServer) SendAndClose(m *LongGreetingResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceLongGreetServer) Recv() (*LongGreetingRequest, error) {
...
type GreetService_GreetEveryoneServer interface {
	Send(*GreetingEveryoneResponse) error
	Recv() (*GreetingEveryoneRequest, error)
	grpc.ServerStream
}
...
func (x *greetServiceGreetEveryoneServer) Send(m *GreetingEveryoneResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetEveryoneServer) Recv() (*GreetingEveryoneRequest, error) {
	m := new(GreetingEveryoneRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "greeting.GreetService",
	...
	Metadata: "greeting/greeting_pb/greeting.proto",
}
